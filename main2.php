...
<body class="conatinerbody">
  ...
     <img src="nitrr.jpg" alt="Avatar" style="display:inline;width:40px;height:40px;margin:5px;align:center" class="w3-circle ">
  ...
  <ul class="nav navbar-nav navbar-right col-sm-4">
    <button style="float:right;text-align:center;margin-right:10px;margin-bottom:10px" type="button" class="btn btn-danger btn-lg btn-inline" class="btn btn-danger" data-toggle="modal" data-target="#myModal">Login</button>
    </ul>
    </div>
  </nav>
  ...
        <div class="modal-body">
              ...
                  <label for="email" style="color:red;font-size:15px"><b>Username :</b></label>
                  <input type="email" class="form-control" id="email" placeholder="Enter Username" name="usrname" required>
                </div>
                <div class="form-group">
...
<div style="margin-left:10px;height:100%" class="conatinersection">
  ...
  <ul class="nav nav-pills">
     ...
     <li style="width:49%"><a data-toggle="pill" href="#menu1">Stsff Login</a></li>
   ...
   <div class="tab-content">
     <div id="home" class="tab-pane fade in active">
       ...
       <form action="/MainPage.php" style="margin:20px;">
         <div class="modal-header">
         <h3 class="modal-title" style="text-align:center;color:red;font-size:20px"><b>Sign Up</b></h3>
            ...
                <input type="number" class="form-control" id="enrollno1" placeholder="Enter Enrollment Number" name="enrollno1" required>
              </div>
            <div class="form-group">
                <label for="pwd" style="color:red;font-size:15px"><b>Password :</b></label>
